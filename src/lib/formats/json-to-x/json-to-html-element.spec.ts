...
import { expandedSpanMarker } from 'src/lib/formats/helpers/html-element-marker/collapsed-span-marker';
...
import { html_element_conflicting_elements } from 'src/lib/formats/test-data/html-element-conflicting-elements';
